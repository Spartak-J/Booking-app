    ...
    <AppLayout variant="stack" header={false} edges={['top', 'left', 'right']}>
      <View style={styles.screen}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            return (
              <Card variant="filled" style={styles.card} onPress={() => navigation.navigate(Routes.AdminOfferDetails, { offerId: item.id })}>
                <ImageBackground
                ...
                <View style={styles.cardBody}>
                  <Typography variant="h2" tone="primary" numberOfLines={3} style={styles.hotelTitle}>
                    {item.name}
                  </Typography>
