  ...
  return (
    <View style={[styles.container, style]}>
      <IconButton
        ...
        icon={<MaterialCommunityIcons name="chevron-left" size={s(18)} color={tokens.textPrimary} />}
      />
      ...
      <IconButton
        ...
        icon={<MaterialCommunityIcons name="chevron-right" size={s(18)} color={tokens.textPrimary} />}
      />
    </View>
  );
};
