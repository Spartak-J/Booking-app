...
const HelpScreenView: React.FC<Props> = ({ role, onBack, onOpenMessages }) => {
  ...
  const faq = [
    { id: 'checkin', title: t('profile.help.faq.checkin.title'), body: t('profile.help.faq.checkin.body') },
    { id: 'payment', title: t('profile.help.faq.payment.title'), body: t('profile.help.faq.payment.body') },
    { id: 'status', title: t('profile.help.faq.status.title'), body: t('profile.help.faq.status.body') },
  ];
