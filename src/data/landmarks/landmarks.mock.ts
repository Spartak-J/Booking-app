...
const BASE: Landmark[] = [
  ...
  },
  {
    ...
    image: landmark4,
    description:
      'Неоготичний храм із вежами та оглядовим майданчиком, звідки видно увесь центр Львова.',
  },
  {
    id: 'lm-lviv-5',
    cityId: 'city-2',
    ...
    image: landmark5,
    description:
      'Пагорб з оглядовим майданчиком і залишками фортеці. Найкращий захід сонця над Львовом.',
  },
