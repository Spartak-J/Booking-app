...
export const EditProfileScreenView: React.FC<EditProfileScreenViewProps> = ({
  ...
  if (isAdmin) {
    return (
      <AdminAccountScreenView initialValues={initialValues} onBack={onBack} onSubmit={onSubmit} />
    );
  }
  ...
  return (
    <UserAccountScreenView initialValues={initialValues} onBack={onBack} onSubmit={onSubmit} />
  );
};
